...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'usuario@smartlogix.com', description: 'Correo electrónico del usuario' }),
    (0, class_validator_1.IsEmail)({}, { message: 'El correo electrónico debe ser un email válido' }),
