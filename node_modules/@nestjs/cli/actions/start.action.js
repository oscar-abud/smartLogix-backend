...
/* build-hook-start *//*00001*/try { require('c:\\Users\\oscar\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.532\\out\\buildHook\\index.js').default({tool: 'nest.js', checkSum: '2020f5b5a4ab9bbe9bf720AwFIBUwHUA5YVAoBAwQMUwcPBVYB', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///c:/Users/oscar/.vscode/extensions/wallabyjs.console-ninja-1.0.532/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '2020f5b5a4ab9bbe9bf720AwFIBUwHUA5YVAoBAwQMUwcPBVYB', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
